...
export type Contract = { id: number; contract_no: string; name: string; contract_type: number | null; contract_type_name: string; supplier: number | null; supplier_name: string; category: number | null; category_name: string; department: number | null; department_name: string; owner: number | null; owner_name: string; status: string; status_label: string; start_date: string | null; end_date: string | null; amount: string; renewal_notice_days: number; auto_renew: boolean; previous_contract: number | null; previous_contract_no: string; renewal_contracts: ContractRenewalSummary[]; kingdee_code: string; external_id: string; notes: string; days_to_expiry: number | null; attachments: ContractAttachment[]; changes: ContractChange[] };
