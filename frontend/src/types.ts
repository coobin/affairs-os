...
export type Supplier = { id: number; code: string; name: string; category: string; brand_name: string; business_scope: string; cooperation_status: string; evaluation: string; cooperation_started: string; channel: string; channel_label: string; contact_name: string; contact_phone: string; contact_email: string; tax_number: string; bank_account: string; address: string; business_license_status: string; business_license_status_label: string; external_id: string; notes: string; is_active: boolean; files: { id: number; original_name: string; document_type: string }[] };
export type Vehicle = { id: number; plate_number: string; name: string; brand: string; model_name: string; vin: string; engine_number: string; energy_type: string; energy_type_label: string; seats: number; status: string; status_label: string; department: number | null; department_name: string; custodian: number | null; custodian_name: string; purchase_date: string | null; registration_date: string | null; purchase_cost: string | null; company: string; use_scope: string; insurance_started_at: string | null; current_mileage: number; insurance_expires_at: string | null; insurer_name: string; inspection_expires_at: string | null; asset_card_code: string; asset_number: string; handler_name: string; supervisor_name: string; notes: string };
...
export type ContractType = { id: number; name: string; code: string; is_active: boolean };
export type ContractAttachment = { id: number; document_type: string; document_type_label: string; change: number | null; change_label: string; original_name: string; content_type: string; size_bytes: number; sha256: string; uploaded_by_name: string; content_url: string; created_at: string };
export type ContractChange = { id: number; change_type: string; change_type_label: string; changed_on: string; old_start_date: string | null; new_start_date: string | null; old_end_date: string | null; new_end_date: string | null; old_amount: string | null; new_amount: string | null; notes: string; created_by_name: string; created_at: string };
export type ContractRenewalSummary = { id: number; contract_no: string; name: string; status: string; status_label: string; start_date: string | null; end_date: string | null };
export type ContractSupplementSummary = { id: number; contract_no: string; name: string; amount: string; start_date: string | null; end_date: string | null; status: string; status_label: string };
export type Contract = { id: number; contract_no: string; name: string; contract_type: number | null; contract_type_name: string; supplier: number | null; supplier_name: string; office: number | null; office_name: string; category: number | null; category_name: string; department: number | null; department_name: string; owner: number | null; owner_name: string; status: string; status_label: string; start_date: string | null; end_date: string | null; amount: string; total_amount: string; amount_description: string; cooperation_duration: string; cooperation_type: string; party_a: string; party_a_contact: string; party_a_address: string; party_b_contact: string; party_b_address: string; payment_method: string; payment_terms: string; invoice_type: string; invoice_tax_rate: string; service_content: string; renewal_notice_days: number; auto_renew: boolean; previous_contract: number | null; previous_contract_no: string; renewal_contracts: ContractRenewalSummary[]; supplement_of: number | null; supplement_of_no: string; supplement_contracts: ContractSupplementSummary[]; kingdee_code: string; external_id: string; notes: string; days_to_expiry: number | null; attachments: ContractAttachment[]; changes: ContractChange[] };
