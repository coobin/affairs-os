...
urlpatterns = [
    ...
    path("settings/operation-logs/", OperationLogView.as_view(), name="operation-logs"),
    path("settings/email-notifications/", EmailNotificationView.as_view(), name="email-notifications"),
